	...
	class JsonFileGenerator < Generator
		...
		def generate(site)
			...
			site.posts.docs.each do |post|
				...
				content = post.content.gsub("/img/", "/content/images/");
				image = post.data['image']  ? post.data['image'].gsub("/img/", "/content/images/") : ""
				ex_post = {
					"id" => id,
          ...
          "feature_image" => image,
					...
					"meta_description" => post.data['summary'],
					"author_id" => author_id,
        ...
        def author_objects(site)
            ...
            default_author = {
                ...
                "website" => "https://bob.conery.io", # Change this to your website
                "location" => "Kauai, HI, US", # Change this to your location
